...
import { Building2, MapPin, Phone, Mail, FileText, Landmark, Loader2 } from 'lucide-react';
...
export const OrganizationRegister: React.FC = () => {
  ...
  return (
    <AuthLayout title="Registrasi Organisasi" subtitle="Lengkapi data organisasi Anda untuk melanjutkan">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="organization_name" name="organization_name" value={form.organization_name} onChange={handleChange} required className="pl-10 h-12" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="company_name" name="company_name" value={form.company_name} onChange={handleChange} required className="pl-10 h-12" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="address" name="address" value={form.address} onChange={handleChange} required className="pl-10 h-12" />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="phone" name="phone" value={form.phone} onChange={handleChange} required className="pl-10 h-12" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" name="email" type="email" value={form.email} onChange={handleChange} required className="pl-10 h-12" />
              </div>
            </div>
          </div>
