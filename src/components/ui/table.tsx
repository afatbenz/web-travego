...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      '[tbody_&]:odd:bg-white [tbody_&]:even:bg-blue-100/30 [tbody_&]:even:hover:bg-blue-100 dark:bg-[#080b11] dark:hover:bg-[#1c2633]',
      '[tbody_&]:odd:hover:bg-gray-100/50 [tbody_&]:even:hover:bg-blue-100/70',
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-14 px-2 text-inherit text-left hover:text-blue-100 align-middle font-medium [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
      className
    )}
    {...props}
  />
